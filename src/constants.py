...
if(LANGUAGE == "pl"):
    ...
    PLAYER_WINS_TXT = PLAYER_WINS_TXT_PL
    AI_WINS_TXT = AI_WINS_TXT_PL
    YOU_BROUGHT_APOCALYPSE_IN_TXT = YOU_BROUGHT_APOCALYPSE_IN_TXT_PL
    YOU_SURVIVED_TXT = YOU_SURVIVED_TXT_PL
    GENERATIONS_TXT = GENERATIONS_TXT_PL
else:
    ...
    PLAYER_WINS_TXT = PLAYER_WINS_TXT_ENG
    AI_WINS_TXT = AI_WINS_TXT_ENG
    YOU_BROUGHT_APOCALYPSE_IN_TXT = YOU_BROUGHT_APOCALYPSE_IN_TXT_ENG
    YOU_SURVIVED_TXT = YOU_SURVIVED_TXT_ENG
    GENERATIONS_TXT = GENERATIONS_TXT_ENG
